/* <BOOK TITLE> — page bootstrap. Runs after KaTeX loads.
   TEMPLATE: replace the `macros` object below with the macros THIS book needs.
   The set here (a meteorology example) shows the style. Rules:
   ...
   - Never shadow KaTeX built-ins (\theta, \P, \E, \k, \deg, \div, ...). Alias to
     a new name instead (e.g. \vtheta for a bold theta vector).
